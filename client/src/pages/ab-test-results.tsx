  ...
  if (isError) {
    return (
      <div className="min-h-screen dark-theme-bg">
        <CardPageHeader title="A/B Test Results" />
        <PageContainer>
              ...
              <CardContent className="p-3 sm:p-4 md:p-6">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                  <div className="p-2 sm:p-2.5 md:p-3 rounded-full bg-slate-800/50 flex-shrink-0">
                    <Activity className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-primary" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <h3 className="text-white font-bold text-base sm:text-lg md:text-xl truncate" data-testid="text-total-tests">{totalTests}</h3>
                    <p className="text-slate-300 text-[10px] sm:text-xs md:text-sm truncate">Total Tests</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border border-slate-700/50 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 rounded-xl sm:rounded-2xl">
              <CardContent className="p-3 sm:p-4 md:p-6">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-white font-bold text-base sm:text-lg md:text-xl truncate" data-testid="text-completed-tests">{completedTests}</h3>
                    <p className="text-slate-300 text-[10px] sm:text-xs md:text-sm truncate">Completed</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border border-slate-700/50 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 rounded-xl sm:rounded-2xl">
              <CardContent className="p-3 sm:p-4 md:p-6">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-white font-bold text-base sm:text-lg md:text-xl truncate" data-testid="text-avg-improvement">+{avgImprovement}%</h3>
                    <p className="text-slate-300 text-[10px] sm:text-xs md:text-sm truncate">Avg Improvement</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="shadow-lg border border-slate-700/50 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 transition-all duration-300 rounded-xl sm:rounded-2xl">
              <CardContent className="p-3 sm:p-4 md:p-6">
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-white font-bold text-base sm:text-lg md:text-xl truncate" data-testid="text-total-participants">{(totalParticipants / 1000).toFixed(1)}K</h3>
                    <p className="text-slate-300 text-[10px] sm:text-xs md:text-sm truncate">Participants</p>
                  </div>
                </div>
              </CardContent>
            </Card>
