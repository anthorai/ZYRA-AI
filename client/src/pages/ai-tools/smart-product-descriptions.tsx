        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            <Button
              ...
              className="text-slate-200 hover:text-primary hover:shadow-lg transition-all duration-300 ease-in-out flex-shrink-0 border-0 rounded-xl shadow-md hover:scale-105"
            >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-base truncate">
                AI generates compelling descriptions in 3 styles: Sales, SEO, and Casual
              </p>
            </div>
          </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">Enter product details & target keywords</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold">2</div>
                <span className="text-slate-300">AI generates 3 style variations</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold">3</div>
                <span className="text-slate-300">Copy or save to your products</span>
              </div>
            </div>
          </CardContent>
        </Card>
