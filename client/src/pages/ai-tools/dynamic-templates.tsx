...
export default function DynamicTemplates() {
  ...
  return (
    <div className="min-h-screen dark-theme-bg text-white">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-base truncate">
                Pre-built tones: Luxury, Gen Z, Eco, Minimalist, and more
              </p>
            </div>
          </div>
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8 bg-[#052557]">
        {/* Process Overview */}
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              {toneTemplates.map((template) => (
                <Card 
                  key={template.id}
                  className="group relative overflow-hidden border-0 gradient-card rounded-xl shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer"
