          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-base truncate">
                Push your optimized product copy directly to Shopify instantly
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-primary mb-2">{optimizedProducts.length}</div>
                <div className="text-slate-300 text-sm">Products Ready</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-400 mb-2">{publishedCount}</div>
                <div className="text-slate-300 text-sm">Published</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-400 mb-2">{optimizedProducts.length - publishedCount}</div>
        ...
        <div className="space-y-6">
          ...
          {optimizedProducts.map((product) => (
            <Card key={product.id} className="border-0 gradient-card rounded-xl">
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 pt-4 border-t border-slate-700/50">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm font-bold text-blue-400">+{product.tags.length - product.originalTags.length}</div>
                  </div>
                  <div className="text-center">
                    <CheckCircle className="w-5 h-5 text-purple-400 mx-auto mb-1" />
                    <div className="text-xs text-slate-300">Readability</div>
                    <div className="text-sm font-bold text-purple-400">Perfect</div>
                  </div>
                </div>
              </CardContent>
            </Card>
