...
import { HelpCircle, ArrowLeft, FileText, MessageSquare, Mail, Users, ExternalLink, Send, Book, Video, LifeBuoy } from "lucide-react";
  ...
  return (
    <div className="p-6 space-y-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="gradient-card border-0 hover:shadow-lg transition-shadow cursor-pointer">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-1">Get instant help</p>
                </div>
              </div>
            </Button>
          </CardContent>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-1">Browse guides & FAQs</p>
                </div>
              </div>
            </Button>
          </CardContent>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-1">Join the discussion</p>
                </div>
              </div>
            </Button>
          </CardContent>
