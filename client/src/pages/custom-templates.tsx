  ...
  return (
    ...
    >
      ...
      <DashboardCard
        ...
        description="Design custom templates for your marketing campaigns"
        testId="card-template-editor"
        headerAction={
...
{discountCode} - Discount code"
      ...
      {/* Saved Templates */}
      <DashboardCard
        title={`Saved Templates (${savedTemplates.length})`}
        description="Manage your existing templates"
        testId="card-saved-templates"
      >
