          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-base truncate">
                Upload product images + tags for richer, more accurate copy generation
              </p>
            </div>
          </div>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-slate-300">Upload product images (up to 3)</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold">2</div>
                <span className="text-slate-300">AI analyzes visual + text attributes</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold">3</div>
                <span className="text-slate-300">Generate rich, contextual copy</span>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {imagePreviews.map((preview, index) => (
                      <div key={index} className="relative">
                        ...
                        <Badge className="absolute bottom-2 left-2 bg-slate-800/80 text-white">
                          Image {index + 1}
                        </Badge>
                      </div>
                    ))}
                    {uploadedImages.length < 3 && (
                      <div 
                        className="h-48 border-2 border-dashed border-slate-600 rounded-lg flex items-center justify-center cursor-pointer hover:border-slate-500 transition-colors"
                        onClick={handleUploadClick}
                      >
                        <div className="text-center">
                          <Plus className="w-8 h-8 text-slate-400 mx-auto mb-2" />
                          <p className="text-slate-400 text-sm">Add Another</p>
                        </div>
                      </div>
                    )}
                  </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-white font-medium mb-2">Colors Detected</h4>
                      <div className="flex flex-wrap gap-2">
                        {generatedContent.imageAnalysis.colors.map((color, index) => (
                          <Badge key={index} className="bg-cyan-400/20 text-cyan-300">
                            {color}
                          </Badge>
                        ))}
                      </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {generatedContent.imageAnalysis.materials.map((material, index) => (
                          <Badge key={index} className="bg-slate-600/50 text-slate-300">
                            {material}
                          </Badge>
                        ))}
                      </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-white font-medium mb-2">Style</h4>
