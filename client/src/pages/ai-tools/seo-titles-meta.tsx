...
export default function SEOTitlesMeta() {
  ...
  return (
    <div className="min-h-screen dark-theme-bg text-white">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-slate-300 text-xs sm:text-sm lg:text-base truncate">
                Keyword-rich, AI-crafted titles and meta descriptions for better search rankings
              </p>
            </div>
          </div>
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto p-4 sm:p-6 space-y-8 bg-[#04214c]">
        {/* SEO Guidelines */}
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 text-sm">
              <div className="space-y-2">
                <h4 className="text-white font-medium">Title Optimization:</h4>
              ...
              <div className="space-y-2">
                <h4 className="text-white font-medium">Meta Description:</h4>
                <ul className="text-slate-300 space-y-1">
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    <div className="text-white font-medium">{seoResult.titleLength}/70</div>
                    <div className="text-slate-300">Title Length</div>
                  </div>
                  <div className="text-center">
                    <div className="text-white font-medium">{seoResult.metaLength}/160</div>
                    <div className="text-slate-300">Meta Length</div>
                  </div>
                  <div className="text-center">
                    <div className="text-white font-medium">{seoResult.keywordDensity}</div>
                    <div className="text-slate-300">Keyword Hits</div>
                  </div>
                </div>
              </CardContent>
            </Card>
