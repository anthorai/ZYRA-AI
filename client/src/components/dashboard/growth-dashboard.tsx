        ...
        {isLoading ? (
          ...
          (Array.from({ length: 6 }, (_, index) => (
            <Card key={`skeleton-${index}`} className="group relative overflow-hidden gradient-card rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 hover:scale-[1.02] border border-slate-700/50 hover:border-primary/30">
              <div className="h-full p-4 sm:p-4 md:p-6 flex flex-col">
            ...
            <div className="h-full p-4 sm:p-4 md:p-6 flex flex-col">
              ...
              <div className="mt-4 sm:mt-4">
                <Button
                  ...
                  className="w-full px-4 sm:px-4 md:px-6 py-2 sm:py-2.5 text-xs sm:text-sm transition-all duration-200 border-0 font-semibold rounded-lg bg-primary text-primary-foreground hover:shadow-lg hover:shadow-primary/30 hover:scale-105 active:scale-95"
